...
anonymous_user = User.create(username: "anonymous_user", email: "anonymous_user@mail.com", password: "epikur", password_confirmation: "epikur", firstname: "Anonymous", lastname: "User")
